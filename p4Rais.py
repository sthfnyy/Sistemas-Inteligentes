...
# DESENHO
# ==========================================================
def desenhar_mapa(largura, altura, inicio, fim, obstaculos, arestas_validas, caminho_destaque=None):
    ...
    if caminho_destaque is not None and len(caminho_destaque) > 1:
        xs = [p[0] for p in caminho_destaque]
        ys = [p[1] for p in caminho_destaque]
        ax.plot(xs, ys, color="red", linewidth=3, label="Caminho destacado")
...
def main():
    ...
    caminho_destaque = caminhos[0] if caminhos else None
    ...
    desenhar_mapa(largura, altura, inicio, fim, obstaculos, arestas_validas, caminho_destaque)
